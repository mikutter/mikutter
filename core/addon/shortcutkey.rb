...
Module.new do
  ...
  plugin.add_event(:keypress){ |key|
    ...
    type_check(tl => (tl and Gtk::TimeLine::InnerTL), active_mumble => (active_mumble and Message), miracle_painter => (miracle_painter and Gdk::MiraclePainter), postbox => (postbox and Gtk::ServiceBox)){
